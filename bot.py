    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "text": {"type": "string"},
                "voice": {"type": "string", "description": "語音名稱，如 zh-CN-YunjianNeural（女）或 zh-CN-YunjianNeural（男）"}
            },
            "required": ["action"]
        }
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "voice": {"type": "string", "description": "語音名稱，預設 zh-CN-YunjianNeural（女聲）。男聲用 zh-CN-YunjianNeural"}
            },
            "required": ["text"]
        }
    },
...
def execute_tts_advanced(action, text="", voice="zh-CN-YunjianNeural"):
    try:
        ...
        if response.stop_reason == "tool_use":
            ...
            simple_tools = {
                ...
                "tts_advanced": lambda: execute_tts_advanced(
                    tool_use.input["action"], tool_use.input.get("text",""),
                    tool_use.input.get("voice","zh-CN-YunjianNeural")),
